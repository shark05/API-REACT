export const DOACOES_LIST_REQUEST = 'DOACOES_LIST_REQUEST';
export const DOACOES_LIST_RECEIVED = 'DOACOES_LIST_RECEIVED';
export const DOACOES_LIST_ERROR = 'DOACOES_LIST_ERROR';
export const DOACOES_LIST_ADD = 'DOACOES_LIST_ADD';
export const DOACOES_LIST_SET_PAGE = 'DOACOES_LIST_SET_PAGE';
export const DOACOES_UNLOAD = 'DOACOES_UNLOAD';
export const DOACOES_FORM_UNLOAD = 'DOACOES_FORM_UNLOAD';
export const DOACOES_REQUEST = 'DOACOES_REQUEST';
export const DOACOES_RECEIVED = 'DOACOES_RECEIVED';
export const DOACOES_ERROR = 'DOACOES_ERROR';

export const MENSALIDADES_LIST_REQUEST = 'MENSALIDADES_LIST_REQUEST';
export const MENSALIDADES_LIST_RECEIVED = 'MENSALIDADES_LIST_RECEIVED';
export const MENSALIDADES_LIST_ERROR = 'MENSALIDADES_LIST_ERROR';
export const MENSALIDADES_LIST_ADD = 'MENSALIDADES_LIST_ADD';
export const MENSALIDADES_LIST_SET_PAGE = 'MENSALIDADES_LIST_SET_PAGE';
