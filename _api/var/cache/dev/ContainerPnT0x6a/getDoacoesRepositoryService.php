 ...
 */
class getDoacoesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DoacoesRepository' shared autowired service.
     *
     * @return \App\Repository\DoacoesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DoacoesRepository.php';

        return $container->privates['App\\Repository\\DoacoesRepository'] = new \App\Repository\DoacoesRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
