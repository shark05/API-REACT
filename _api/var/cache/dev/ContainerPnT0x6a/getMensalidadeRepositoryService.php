 ...
 */
class getMensalidadeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\MensalidadeRepository' shared autowired service.
     *
     * @return \App\Repository\MensalidadeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MensalidadeRepository.php';

        return $container->privates['App\\Repository\\MensalidadeRepository'] = new \App\Repository\MensalidadeRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
