 ...
 */
class getDoadorRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DoadorRepository' shared autowired service.
     *
     * @return \App\Repository\DoadorRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DoadorRepository.php';

        return $container->privates['App\\Repository\\DoadorRepository'] = new \App\Repository\DoadorRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
